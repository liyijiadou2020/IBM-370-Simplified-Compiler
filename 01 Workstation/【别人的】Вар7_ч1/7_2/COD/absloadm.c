...
#define  NOBJ   80                                /*разм.масс.об'ектных карт*/
...
int P_SLR()                                         /*  п р о г р а м м а     */
 ...
 {                                                /*команды A               */
  ...
  VR[R1] = VR[R1] >> ADDR;                          /*сложение с 1-м операндом*/
  return 0;                                       /*успешное заверш. прогр. */
 }
int P_SLL()                                         /*  п р о г р а м м а     */
 ...
 {                                                /*команды A               */
  ...
  VR[R1] = VR[R1] << ADDR & 0xFFFFFFFF;                          /*сложение с 1-м операндом*/
